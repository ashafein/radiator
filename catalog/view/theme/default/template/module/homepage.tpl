<?php if ($homepages) { ?>
  <?php if ($layout_option == 'tabbed') { ?>
    ...
    <?php for ($i = 0; $i < sizeof($homepages); $i++) { ?>
      <div id="tab_<?php echo $i; ?>" class="tab-content" style="min-height: <?php echo $min_height; ?>px;">
        ...
        <img src="<?php echo $homepages[$i]['image']; ?>" title="<?php echo $homepages[$i]['title']; ?>" alt="<?php echo $homepages[$i]['title']; ?>" />
        <?php } ?>
      ...
      <?php for ($i = 0; $i < sizeof($homepages); $i = $i + $cols) { ?>
        <tr>
          ...
          <td style="width: <?php echo $col_width; ?>%;"><?php if (isset($homepages[$j])) { ?>
            ...
            <img src="<?php echo $homepages[$j]['image']; ?>" title="<?php echo $homepages[$j]['title']; ?>" alt="<?php echo $homepages[$j]['title']; ?>" />
            <?php } ?>
  ...
  <?php } else { ?>
    ...
    <div class="homepage">
      ...
      <img src="<?php echo $homepage['image']; ?>" title="<?php echo $homepage['title']; ?>" alt="<?php echo $homepage['title']; ?>" />
      <?php } ?>
