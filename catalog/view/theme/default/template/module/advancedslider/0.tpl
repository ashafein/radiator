...
<?php 	$this->document->addScript('catalog/view/javascript/nivo32/jquery.nivo.slider.pack.js');
		...
		$this->document->addStyle('catalog/view/theme/default/stylesheet/nivo-themes/default/default.css');	?>
...
<div class="slider-wrapper theme-default" style="width: <?php echo $width; ?>px; height: <?php echo $height+30; ?>px;">
