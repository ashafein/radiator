<!-- advanced slider nivo-dark-thumbs -->
<?php 	$this->document->addScript('catalog/view/javascript/nivo32/jquery.nivo.slider.pack.js');
		...
		$this->document->addStyle('catalog/view/theme/default/stylesheet/nivo-themes/dark/dark_thumb.css');	?>
...
<div class="slider-wrapper theme-dark" style="width: <?php echo $width; ?>px; height: <?php echo $height+100; ?>px;">
